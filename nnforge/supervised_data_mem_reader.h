...
namespace nnforge
{
	...
	protected:
		...
		std::vector<std::shared_ptr<const std::vector<unsigned char> > > input_data_list_byte;
		std::vector<std::shared_ptr<const std::vector<float> > > input_data_list_float;
		std::vector<std::shared_ptr<const std::vector<float> > > output_data_list;
