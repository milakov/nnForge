...
namespace nnforge
{
	namespace plain
	{
		class hyperbolic_tangent_layer_updater_plain : public layer_updater_plain
		{
		public:
			hyperbolic_tangent_layer_updater_plain() = default;

			virtual ~hyperbolic_tangent_layer_updater_plain() = default;
