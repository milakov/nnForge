...
namespace nnforge
{
	namespace plain
	{
		class exponential_linear_layer_updater_plain : public layer_updater_plain
		{
		public:
			exponential_linear_layer_updater_plain() = default;

			virtual ~exponential_linear_layer_updater_plain() = default;
