...
namespace nnforge
{
	namespace plain
	{
		class average_subsampling_layer_hessian_plain : public layer_hessian_plain
		{
		public:
			average_subsampling_layer_hessian_plain();

			virtual ~average_subsampling_layer_hessian_plain();
