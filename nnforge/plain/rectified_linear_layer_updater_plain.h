...
namespace nnforge
{
	namespace plain
	{
		class rectified_linear_layer_updater_plain : public layer_updater_plain
		{
		public:
			rectified_linear_layer_updater_plain() = default;

			virtual ~rectified_linear_layer_updater_plain() = default;
