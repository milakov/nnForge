...
namespace nnforge
{
	namespace plain
	{
		absolute_layer_hessian_plain::absolute_layer_hessian_plain()
		{
		}
		...
		const boost::uuids::uuid& absolute_layer_hessian_plain::get_uuid() const
		{
			return absolute_layer::layer_guid;
		}

		void absolute_layer_hessian_plain::test(
		...
		void absolute_layer_hessian_plain::backprop(
		...
		bool absolute_layer_hessian_plain::is_in_place_backprop() const
		{
			return true;
		}
	}
