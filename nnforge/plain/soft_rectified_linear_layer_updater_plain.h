...
namespace nnforge
{
	namespace plain
	{
		class soft_rectified_linear_layer_updater_plain : public layer_updater_plain
		{
		public:
			soft_rectified_linear_layer_updater_plain();

			virtual ~soft_rectified_linear_layer_updater_plain();
