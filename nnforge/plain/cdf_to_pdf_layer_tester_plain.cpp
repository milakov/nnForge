...
namespace nnforge
{
	namespace plain
	{
		cdf_to_pdf_layer_tester_plain::cdf_to_pdf_layer_tester_plain()
		{
		}
		...
		std::string cdf_to_pdf_layer_tester_plain::get_type_name() const
		{
			return cdf_to_pdf_layer::layer_type_name;
		}

		void cdf_to_pdf_layer_tester_plain::run_forward_propagation(
		...
		int cdf_to_pdf_layer_tester_plain::get_input_index_layer_can_write(
			plain_running_configuration::const_ptr plain_config,
			layer::const_ptr layer_schema,
			const std::vector<layer_configuration_specific>& input_configuration_specific_list,
