...
namespace nnforge
{
	namespace plain
	{
		class linear_sampler_layer_updater_plain : public layer_updater_plain
		{
		public:
			linear_sampler_layer_updater_plain() = default;

			virtual ~linear_sampler_layer_updater_plain() = default;
