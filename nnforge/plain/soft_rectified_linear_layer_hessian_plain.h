...
namespace nnforge
{
	namespace plain
	{
		class soft_rectified_linear_layer_hessian_plain : public layer_hessian_plain
		{
		public:
			soft_rectified_linear_layer_hessian_plain();

			virtual ~soft_rectified_linear_layer_hessian_plain();
