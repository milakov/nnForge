...
namespace nnforge
{
	namespace plain
	{
		class sparse_convolution_layer_updater_plain : public layer_updater_plain
		{
		public:
			sparse_convolution_layer_updater_plain() = default;

			virtual ~sparse_convolution_layer_updater_plain() = default;
