...
namespace nnforge
{
	namespace plain
	{
		accuracy_layer_updater_plain::accuracy_layer_updater_plain()
		{
		}
		...
		std::string accuracy_layer_updater_plain::get_type_name() const
		{
			return accuracy_layer::layer_type_name;
		}

		void accuracy_layer_updater_plain::run_forward_propagation(
