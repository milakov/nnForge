...
namespace nnforge
{
	namespace plain
	{
		class cross_entropy_layer_updater_plain : public layer_updater_plain
		{
		public:
			cross_entropy_layer_updater_plain() = default;

			virtual ~cross_entropy_layer_updater_plain() = default;
