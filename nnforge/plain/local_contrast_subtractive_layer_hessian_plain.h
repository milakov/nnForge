...
namespace nnforge
{
	namespace plain
	{
		class local_contrast_subtractive_layer_hessian_plain : public layer_hessian_plain
		{
		public:
			local_contrast_subtractive_layer_hessian_plain();

			virtual ~local_contrast_subtractive_layer_hessian_plain();
