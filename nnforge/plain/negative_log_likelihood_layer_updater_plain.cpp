...
namespace nnforge
{
	namespace plain
	{
		...
		void negative_log_likelihood_layer_updater_plain::run_forward_propagation(
		...
		void negative_log_likelihood_layer_updater_plain::run_backward_data_propagation(
		...
		bool negative_log_likelihood_layer_updater_plain::is_backward_data_dependent_on_input_buffer(
		...
		bool negative_log_likelihood_layer_updater_plain::is_backward_data_dependent_on_output_buffer(
			unsigned int action_input_index,
			const std::set<layer_action>& actions,
			plain_running_configuration::const_ptr plain_config,
			layer::const_ptr layer_schema,
