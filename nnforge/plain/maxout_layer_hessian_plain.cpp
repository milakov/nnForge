...
namespace nnforge
{
	namespace plain
	{
		maxout_layer_hessian_plain::maxout_layer_hessian_plain()
		{
		}
		...
		const boost::uuids::uuid& maxout_layer_hessian_plain::get_uuid() const
		{
			return maxout_layer::layer_guid;
		}

		void maxout_layer_hessian_plain::test(
		...
		void maxout_layer_hessian_plain::backprop(
		...
		std::vector<std::pair<unsigned int, bool> > maxout_layer_hessian_plain::get_elem_count_and_per_entry_flag_additional_buffers(
			const_layer_smart_ptr layer_schema,
			const layer_configuration_specific& input_configuration_specific,
			const layer_configuration_specific& output_configuration_specific,
			plain_running_configuration_const_smart_ptr plain_config,
		...
		bool maxout_layer_hessian_plain::is_in_place_backprop() const
		{
			return false;
		}
	}
