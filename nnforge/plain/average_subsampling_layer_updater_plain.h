...
namespace nnforge
{
	namespace plain
	{
		class average_subsampling_layer_updater_plain : public layer_updater_plain
		{
		public:
			average_subsampling_layer_updater_plain() = default;

			virtual ~average_subsampling_layer_updater_plain() = default;
