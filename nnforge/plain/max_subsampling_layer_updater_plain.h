...
namespace nnforge
{
	namespace plain
	{
		class max_subsampling_layer_updater_plain : public layer_updater_plain
		{
		public:
			max_subsampling_layer_updater_plain() = default;

			virtual ~max_subsampling_layer_updater_plain() = default;
