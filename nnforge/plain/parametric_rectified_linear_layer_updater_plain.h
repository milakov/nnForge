...
namespace nnforge
{
	namespace plain
	{
		class parametric_rectified_linear_layer_updater_plain : public layer_updater_plain
		{
		public:
			parametric_rectified_linear_layer_updater_plain() = default;

			virtual ~parametric_rectified_linear_layer_updater_plain() = default;
