...
namespace nnforge
{
	namespace plain
	{
		...
		typedef nnforge_shared_ptr<layer_hessian_plain> layer_hessian_plain_smart_ptr;
		typedef nnforge_shared_ptr<const layer_hessian_plain> const_layer_hessian_plain_smart_ptr;
