...
namespace nnforge
{
	namespace plain
	{
		...
		struct hessian_additional_buffer_set
		{
		...
		class layer_hessian_plain
		{
		public:
			virtual ~layer_hessian_plain();
			...
			hessian_additional_buffer_set allocate_additional_buffers(
		...
		private:
			layer_hessian_plain(const layer_hessian_plain&);
			layer_hessian_plain& operator =(const layer_hessian_plain&);
		};

		typedef std::tr1::shared_ptr<layer_hessian_plain> layer_hessian_plain_smart_ptr;
		typedef std::tr1::shared_ptr<const layer_hessian_plain> const_layer_hessian_plain_smart_ptr;
		typedef std::vector<const_layer_hessian_plain_smart_ptr> const_layer_hessian_plain_list;
	}
}
