...
namespace nnforge
{
	namespace plain
	{
		class gradient_modifier_layer_updater_plain : public layer_updater_plain
		{
		public:
			gradient_modifier_layer_updater_plain() = default;

			virtual ~gradient_modifier_layer_updater_plain() = default;
