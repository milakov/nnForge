...
namespace nnforge
{
	...
	void convolution_layer::write_proto(void * layer_proto) const
	{
		...
		nnforge::protobuf::ConvolutionalParam * param = layer_proto_typed->mutable_convolution_param();
		...
		{
			nnforge::protobuf::ConvolutionalParam_ConvolutionalDimensionParam * dim_param = param->add_dimension_param();
