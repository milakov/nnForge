...
namespace nnforge
{
	...
	layer_configuration_specific mse_layer::get_input_layer_configuration_specific(
		const layer_configuration_specific& output_configuration_specific,
		unsigned int input_layer_id) const
	{
		throw neural_network_exception("mse_layer cannot run get_input_layer_configuration_specific");
	}
