...
namespace nnforge
{
	namespace cuda
	{
		class convolution_3d_layer_hessian_cuda_fermi : public layer_hessian_cuda
		{
		public:
			convolution_3d_layer_hessian_cuda_fermi();

			virtual ~convolution_3d_layer_hessian_cuda_fermi();
