...
namespace nnforge
{
	namespace cuda
	{
		...
		std::string rgb_to_yuv_convert_layer_updater_schema::get_type_name() const
		{
			return rgb_to_yuv_convert_layer::layer_type_name;
		}

		layer_updater_cuda::ptr rgb_to_yuv_convert_layer_updater_schema::create_updater_specific(
			const std::vector<layer_configuration_specific>& input_configuration_specific_list,
			const layer_configuration_specific& output_configuration_specific) const
		{
			return layer_updater_cuda::ptr(new rgb_to_yuv_convert_layer_updater_cuda());
		}

		std::vector<cuda_linear_buffer_device::const_ptr> rgb_to_yuv_convert_layer_updater_schema::get_schema_buffers() const
		{
