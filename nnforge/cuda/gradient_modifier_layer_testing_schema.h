...
namespace nnforge
{
	namespace cuda
	{
		class gradient_modifier_layer_testing_schema : public layer_testing_schema
		{
		public:
			gradient_modifier_layer_testing_schema() = default;

			virtual ~gradient_modifier_layer_testing_schema() = default;
