...
namespace nnforge
{
	namespace cuda
	{
		class convolution_1d_layer_hessian_cuda_fermi : public layer_hessian_cuda
		{
		public:
			convolution_1d_layer_hessian_cuda_fermi();

			virtual ~convolution_1d_layer_hessian_cuda_fermi();
