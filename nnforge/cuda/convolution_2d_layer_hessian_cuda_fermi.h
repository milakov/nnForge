...
namespace nnforge
{
	namespace cuda
	{
		class convolution_2d_layer_hessian_cuda_fermi : public layer_hessian_cuda
		{
		public:
			convolution_2d_layer_hessian_cuda_fermi();

			virtual ~convolution_2d_layer_hessian_cuda_fermi();
