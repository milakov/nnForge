...
namespace nnforge
{
	namespace cuda
	{
		class parametric_rectified_linear_layer_updater_cuda : public layer_updater_cuda
		{
		public:
			parametric_rectified_linear_layer_updater_cuda() = default;

			virtual ~parametric_rectified_linear_layer_updater_cuda() = default;
		...
		private:
			static int get_update_block_size(int entry_count);
		};
	}
}
