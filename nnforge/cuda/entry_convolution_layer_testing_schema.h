...
namespace nnforge
{
	namespace cuda
	{
		class entry_convolution_layer_testing_schema : public layer_testing_schema
		{
		public:
			entry_convolution_layer_testing_schema() = default;

			virtual ~entry_convolution_layer_testing_schema() = default;
