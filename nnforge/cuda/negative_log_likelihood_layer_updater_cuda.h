...
namespace nnforge
{
	namespace cuda
	{
		class negative_log_likelihood_layer_updater_cuda : public layer_updater_cuda
		{
		public:
			negative_log_likelihood_layer_updater_cuda() = default;

			virtual ~negative_log_likelihood_layer_updater_cuda() = default;
