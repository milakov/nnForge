...
namespace nnforge
{
	namespace cuda
	{
		class soft_rectified_linear_layer_updater_schema : public layer_updater_schema
		{
		public:
			soft_rectified_linear_layer_updater_schema();

			virtual ~soft_rectified_linear_layer_updater_schema();
