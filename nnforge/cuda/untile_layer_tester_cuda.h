...
namespace nnforge
{
	namespace cuda
	{
		class untile_layer_tester_cuda : public layer_tester_cuda
		{
		public:
			untile_layer_tester_cuda() = default;

			virtual ~untile_layer_tester_cuda() = default;
		...
		private:
			...
			int_fastdiv total_tiling_factor;
		};
	}
}
