...
namespace nnforge
{
	namespace cuda
	{
		hyperbolic_tangent_layer_hessian_schema::hyperbolic_tangent_layer_hessian_schema()
		{
		}
		...
		const boost::uuids::uuid& hyperbolic_tangent_layer_hessian_schema::get_uuid() const
		{
			return hyperbolic_tangent_layer::layer_guid;
		}

		layer_hessian_cuda_smart_ptr hyperbolic_tangent_layer_hessian_schema::create_hessian_specific(
			const layer_configuration_specific& hyperbolic_tangent_layer_hessian_schema,
			const layer_configuration_specific& output_configuration_specific) const
		{
			return layer_hessian_cuda_smart_ptr(new hyperbolic_tangent_layer_hessian_cuda());
		}
	}
}
