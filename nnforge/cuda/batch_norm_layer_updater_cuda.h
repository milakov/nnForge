...
namespace nnforge
{
	namespace cuda
	{
		class batch_norm_layer_updater_cuda : public layer_updater_cuda
		{
		public:
			batch_norm_layer_updater_cuda();

			virtual ~batch_norm_layer_updater_cuda();
		...
		private:
			...
			static const float mean_and_variance_gradient_slope;
		};
	}
}
