...
namespace nnforge
{
	namespace cuda
	{
		class max_subsampling_layer_hessian_schema : public layer_hessian_schema
		{
		public:
			max_subsampling_layer_hessian_schema();

			virtual ~max_subsampling_layer_hessian_schema();
