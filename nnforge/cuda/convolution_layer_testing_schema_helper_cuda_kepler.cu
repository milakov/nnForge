...
#include "convolution_layer_tester_cuda_kepler.cuh"
...
namespace nnforge
{
	namespace cuda
	{
				...
				const layer_configuration_specific& output_configuration_specific)
		{
			...
			{
				case 1:
					res = layer_tester_cuda_smart_ptr(new convolution_layer_tester_cuda_kepler<1>());
					break;
				case 2:
					res = layer_tester_cuda_smart_ptr(new convolution_layer_tester_cuda_kepler<2>());
					break;
				case 3:
