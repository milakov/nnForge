...
namespace nnforge
{
	namespace cuda
	{
		...
		layer_testing_schema::ptr negative_log_likelihood_layer_testing_schema::create_specific() const
		{
			return layer_testing_schema::ptr(new negative_log_likelihood_layer_testing_schema());
		}

		layer_tester_cuda::ptr negative_log_likelihood_layer_testing_schema::create_tester_specific(
			const std::vector<layer_configuration_specific>& input_configuration_specific_list,
			const layer_configuration_specific& output_configuration_specific) const
		{
			return layer_tester_cuda::ptr(new negative_log_likelihood_layer_tester_cuda());
		}
	}
}
