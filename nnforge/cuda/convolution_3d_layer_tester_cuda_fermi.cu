...
#define launch_kernel(block_size) \
	switch (block_size) \
		...
		void convolution_3d_layer_tester_cuda_fermi::enqueue_test(
		...
		int convolution_3d_layer_tester_cuda_fermi::get_block_size(int output_width)
		{
		...
		void convolution_3d_layer_tester_cuda_fermi::tester_configured()
		{
		...
		std::vector<unsigned int> convolution_3d_layer_tester_cuda_fermi::get_linear_addressing_through_texture_per_entry() const
		{
		...
		cuda_linear_buffer_device_smart_ptr convolution_3d_layer_tester_cuda_fermi::get_output_buffer(
			cuda_linear_buffer_device_smart_ptr input_buffer,
			const std::vector<cuda_linear_buffer_device_smart_ptr>& additional_buffers)
		{
