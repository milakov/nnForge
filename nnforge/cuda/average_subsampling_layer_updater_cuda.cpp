...
namespace nnforge
{
	namespace cuda
	{
		average_subsampling_layer_updater_cuda::average_subsampling_layer_updater_cuda()
			: input_data_desc(0)
			, output_data_desc(0)
			, subsampling_desc(0)
		{
		...
		void average_subsampling_layer_updater_cuda::enqueue_test(
		...
		void average_subsampling_layer_updater_cuda::enqueue_backprop(
			cudaStream_t stream_id,
			const std::vector<const_cuda_linear_buffer_device_smart_ptr>& schema_data,
			const std::vector<cuda_linear_buffer_device_smart_ptr>& data,
			const std::vector<cuda_linear_buffer_device_smart_ptr>& data_custom,
		...
		void average_subsampling_layer_updater_cuda::updater_configured()
		{
		...
		bool average_subsampling_layer_updater_cuda::is_in_place_backprop() const
		{
			return false;
		}
	}
