...
namespace nnforge
{
	namespace cuda
	{
		class entry_convolution_layer_updater_cuda : public layer_updater_cuda
		{
		public:
			entry_convolution_layer_updater_cuda() = default;

			virtual ~entry_convolution_layer_updater_cuda() = default;
