...
namespace nnforge
{
	namespace cuda
	{
		class convolution_3d_layer_tester_cuda_fermi : public layer_tester_cuda
		{
		public:
			convolution_3d_layer_tester_cuda_fermi();

			virtual ~convolution_3d_layer_tester_cuda_fermi();
