...
namespace nnforge
{
	namespace cuda
	{
		class average_subsampling_layer_hessian_schema : public layer_hessian_schema
		{
		public:
			average_subsampling_layer_hessian_schema();

			virtual ~average_subsampling_layer_hessian_schema();
