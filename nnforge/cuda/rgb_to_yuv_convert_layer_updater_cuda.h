...
namespace nnforge
{
	namespace cuda
	{
		class rgb_to_yuv_convert_layer_updater_cuda : public layer_updater_cuda
		{
		public:
			rgb_to_yuv_convert_layer_updater_cuda() = default;

			virtual ~rgb_to_yuv_convert_layer_updater_cuda() = default;
