...
namespace nnforge
{
	namespace cuda
	{
		class hyperbolic_tangent_layer_hessian_schema : public layer_hessian_schema
		{
		public:
			hyperbolic_tangent_layer_hessian_schema();

			virtual ~hyperbolic_tangent_layer_hessian_schema();
