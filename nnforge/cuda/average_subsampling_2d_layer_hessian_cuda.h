...
namespace nnforge
{
	namespace cuda
	{
		class average_subsampling_2d_layer_hessian_cuda : public layer_hessian_cuda
		{
		public:
			average_subsampling_2d_layer_hessian_cuda();

			virtual ~average_subsampling_2d_layer_hessian_cuda();
