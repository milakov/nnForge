...
namespace nnforge
{
	namespace cuda
	{
		class local_contrast_subtractive_layer_hessian_schema : public layer_hessian_schema
		{
		public:
			local_contrast_subtractive_layer_hessian_schema();

			virtual ~local_contrast_subtractive_layer_hessian_schema();
