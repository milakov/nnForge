	...
	namespace cuda
	{
			...
			int packed_config_count)
		{
			...
			if (in_bounds)
			{
				...
				int base_input_feature_map_id = conf.get_val(3);
			...
			int packed_config_count)
		{
			...
			if (in_bounds)
			{
				...
				int base_output_feature_map_id = conf.get_val(3);
			...
			int packed_config_count)
		{
			...
			if (in_bounds)
			{
				...
				int output_feature_map_id = conf.get_val(2);
				int output_y_start_id = conf.get_val(3);
...
#define launch_exact_kernel_const_const(window_width_const, block_size_const, single_input_feature_map_group) \
	convolution_2d_tex_exact_upd_kernel_fermi<window_width_const,block_size_const,single_input_feature_map_group><<<kernel_dims.first, kernel_dims.second, 0, stream_id>>>(*output_neurons_buffer, *data[0], *data[1], packed_config_list, output_configuration_specific.dimension_sizes[0], output_configuration_specific.dimension_sizes[1], input_configuration_specific.dimension_sizes[0], input_configuration_specific.dimension_sizes[1], window_sizes[1], input_configuration_specific.feature_map_count, output_configuration_specific.feature_map_count, forward_input_feature_map_group_size, texture_offset, entry_count, different_input, packed_config_count);
...
#define launch_kernel_const(block_size_const, single_input_feature_map_group) \
	convolution_2d_tex_upd_kernel_fermi<block_size_const,single_input_feature_map_group><<<kernel_dims.first, kernel_dims.second, 0, stream_id>>>(*output_neurons_buffer, *data[0], *data[1], packed_config_list, output_configuration_specific.dimension_sizes[0], output_configuration_specific.dimension_sizes[1], input_configuration_specific.dimension_sizes[0], input_configuration_specific.dimension_sizes[1], window_sizes[0], window_sizes[1], input_configuration_specific.feature_map_count, output_configuration_specific.feature_map_count, forward_input_feature_map_group_size, texture_offset, entry_count, different_input, packed_config_count);
...
#define launch_backprop_exact_kernel_const_const(window_width_const, block_size_const, single_output_feature_map_group) \
	convolution_2d_deriviative_tex_exact_upd_kernel_fermi<window_width_const,block_size_const,single_output_feature_map_group><<<kernel_dims.first, kernel_dims.second, 0, stream_id>>>(*input_errors_buffer, *data[0], packed_config_list, output_configuration_specific.dimension_sizes[0], output_configuration_specific.dimension_sizes[1], input_configuration_specific.dimension_sizes[0], input_configuration_specific.dimension_sizes[1], window_sizes[1], input_configuration_specific.feature_map_count, output_configuration_specific.feature_map_count, backward_output_feature_map_group_size, entry_count, packed_config_count);
...
#define launch_backprop_kernel_const(block_size_const, single_output_feature_map_group) \
	convolution_2d_deriviative_tex_upd_kernel_fermi<block_size_const,single_output_feature_map_group><<<kernel_dims.first, kernel_dims.second, 0, stream_id>>>(*input_errors_buffer, *data[0], packed_config_list, output_configuration_specific.dimension_sizes[0], output_configuration_specific.dimension_sizes[1], input_configuration_specific.dimension_sizes[0], input_configuration_specific.dimension_sizes[1], window_sizes[0], window_sizes[1], input_configuration_specific.feature_map_count, output_configuration_specific.feature_map_count, backward_output_feature_map_group_size, entry_count, packed_config_count);
...
#define launch_update_weights_exact_kernel_const(window_width_const, single_output_y_group_const) \
	convolution_2d_update_weights_exact_upd_kernel_fermi<window_width_const, single_output_y_group_const><<<kernel_dims.first, kernel_dims.second, 0, stream_id>>>(*data[0], *output_errors_buffer, *training_speed[0], packed_config_list, output_configuration_specific.dimension_sizes[0], output_configuration_specific.dimension_sizes[1], input_configuration_specific.dimension_sizes[0], input_configuration_specific.dimension_sizes[1], window_sizes[1], input_configuration_specific.feature_map_count, output_configuration_specific.feature_map_count, updater_output_y_group_count, texture_offset, entry_count, different_input, packed_config_count);
...
#define launch_update_weights_kernel_const(single_output_y_group_const) \
	convolution_2d_update_weights_upd_kernel_fermi<single_output_y_group_const><<<kernel_dims.first, kernel_dims.second, 0, stream_id>>>(*data[0], *output_errors_buffer, *training_speed[0], packed_config_list, output_configuration_specific.dimension_sizes[0], output_configuration_specific.dimension_sizes[1], input_configuration_specific.dimension_sizes[0], input_configuration_specific.dimension_sizes[1], window_sizes[0], window_sizes[1], input_configuration_specific.feature_map_count, output_configuration_specific.feature_map_count, updater_output_y_group_count, texture_offset, entry_count, different_input, packed_config_count);
			...
			unsigned int entry_count)
		{
			...
			int packed_config_count = forward_x_block_count * output_configuration_specific.dimension_sizes[1] * forward_output_feature_map_block_count * forward_input_feature_map_group_count;
			const packed_config<4> * packed_config_list = static_cast<const packed_config<4> *>((const void *)*additional_buffers[0]);
			...
			unsigned int entry_count)
		{
			...
			int packed_config_count = backward_x_block_count * input_configuration_specific.dimension_sizes[1] * backward_input_feature_map_block_count * backward_output_feature_map_group_count;
			...
			unsigned int entry_count)
		{
			...
			int packed_config_count = window_sizes[1] * updater_output_y_group_count * updater_output_feature_map_block_count * input_configuration_specific.feature_map_count;
			const packed_config<4> * packed_config_list = static_cast<const packed_config<4> *>((const void *)*additional_buffers[1]);
		...
		std::vector<size_t> convolution_2d_layer_updater_cuda_fermi::get_sizes_of_additional_buffers_fixed() const
		{
			...
			res.push_back(sizeof(packed_config<4>) * forward_x_block_count * output_configuration_specific.dimension_sizes[1] * input_configuration_specific.feature_map_count * forward_output_feature_map_block_count);
			...
			if (backprop_required)
				res.push_back(sizeof(packed_config<4>) * backward_x_block_count * input_configuration_specific.dimension_sizes[1] * output_configuration_specific.feature_map_count * backward_input_feature_map_block_count);
		...
		{
			{
				...
				{
					new_elem.set_val(3, input_feature_map_group_id * forward_input_feature_map_group_size);
				...
				cuda_safe_call(cudaMemcpy(*additional_buffers[0], &(*task_list.begin()), sizeof(packed_config<4>) * task_list.size(), cudaMemcpyHostToDevice));
			}

			{
				...
				cuda_safe_call(cudaMemcpy(*additional_buffers[1], &(*task_list.begin()), sizeof(packed_config<4>) * task_list.size(), cudaMemcpyHostToDevice));
			}
			...
			if (backprop_required)
			{
				...
				{
					new_elem.set_val(3, output_feature_map_group_id * backward_output_feature_map_group_size);
