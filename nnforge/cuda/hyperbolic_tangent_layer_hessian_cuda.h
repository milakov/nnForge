...
namespace nnforge
{
	namespace cuda
	{
		class hyperbolic_tangent_layer_hessian_cuda : public layer_hessian_cuda
		{
		public:
			hyperbolic_tangent_layer_hessian_cuda();

			virtual ~hyperbolic_tangent_layer_hessian_cuda();
