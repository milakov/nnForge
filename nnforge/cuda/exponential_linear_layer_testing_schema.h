...
namespace nnforge
{
	namespace cuda
	{
		class exponential_linear_layer_testing_schema : public layer_testing_schema
		{
		public:
			exponential_linear_layer_testing_schema() = default;

			virtual ~exponential_linear_layer_testing_schema() = default;
