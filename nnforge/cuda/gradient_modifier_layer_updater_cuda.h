...
namespace nnforge
{
	namespace cuda
	{
		class gradient_modifier_layer_updater_cuda : public layer_updater_cuda
		{
		public:
			gradient_modifier_layer_updater_cuda() = default;

			virtual ~gradient_modifier_layer_updater_cuda() = default;
