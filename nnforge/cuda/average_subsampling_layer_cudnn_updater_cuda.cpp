...
namespace nnforge
{
	namespace cuda
	{
		average_subsampling_layer_cudnn_updater_cuda::average_subsampling_layer_cudnn_updater_cuda()
			: input_data_desc(0)
			, output_data_desc(0)
			, subsampling_desc(0)
		{
		...
		void average_subsampling_layer_cudnn_updater_cuda::enqueue_forward_propagation(
		...
		void average_subsampling_layer_cudnn_updater_cuda::enqueue_backward_data_propagation(
			cudaStream_t stream_id,
		...
		void average_subsampling_layer_cudnn_updater_cuda::updater_configured()
		{
		...
		bool average_subsampling_layer_cudnn_updater_cuda::is_backward_data_dependent_on_output_buffer(unsigned int action_input_index) const
		{
			return true;
		}
	}
