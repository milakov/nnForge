...
namespace nnforge
{
	namespace cuda
	{
		class soft_rectified_linear_layer_hessian_schema : public layer_hessian_schema
		{
		public:
			soft_rectified_linear_layer_hessian_schema();

			virtual ~soft_rectified_linear_layer_hessian_schema();
