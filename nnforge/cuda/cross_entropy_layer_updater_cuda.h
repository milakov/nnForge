...
namespace nnforge
{
	namespace cuda
	{
		class cross_entropy_layer_updater_cuda : public layer_updater_cuda
		{
		public:
			cross_entropy_layer_updater_cuda() = default;

			virtual ~cross_entropy_layer_updater_cuda() = default;
