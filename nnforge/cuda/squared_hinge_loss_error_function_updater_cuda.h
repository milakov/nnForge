...
namespace nnforge
{
	namespace cuda
	{
		class squared_hinge_loss_error_function_updater_cuda : public error_function_updater_cuda
		{
		public:
			squared_hinge_loss_error_function_updater_cuda();

			virtual ~squared_hinge_loss_error_function_updater_cuda();
