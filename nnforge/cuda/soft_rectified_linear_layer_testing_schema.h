...
namespace nnforge
{
	namespace cuda
	{
		class soft_rectified_linear_layer_testing_schema : public layer_testing_schema
		{
		public:
			soft_rectified_linear_layer_testing_schema();

			virtual ~soft_rectified_linear_layer_testing_schema();
