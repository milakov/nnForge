...
namespace nnforge
{
	namespace cuda
	{
		...
		void average_subsampling_layer_cudnn_tester_cuda::enqueue_test(
		...
		cuda_linear_buffer_device_smart_ptr average_subsampling_layer_cudnn_tester_cuda::get_output_buffer(
			cuda_linear_buffer_device_smart_ptr input_buffer,
			const std::vector<cuda_linear_buffer_device_smart_ptr>& additional_buffers)
		{
		...
		std::vector<size_t> average_subsampling_layer_cudnn_tester_cuda::get_sizes_of_additional_buffers_per_entry() const
		{
