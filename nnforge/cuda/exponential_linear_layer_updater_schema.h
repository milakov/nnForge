...
namespace nnforge
{
	namespace cuda
	{
		class exponential_linear_layer_updater_schema : public layer_updater_schema
		{
		public:
			exponential_linear_layer_updater_schema() = default;

			virtual ~exponential_linear_layer_updater_schema() = default;
