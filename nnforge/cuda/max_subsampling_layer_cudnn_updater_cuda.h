...
namespace nnforge
{
	namespace cuda
	{
		class max_subsampling_layer_cudnn_updater_cuda : public layer_updater_cuda
		{
		public:
			max_subsampling_layer_cudnn_updater_cuda();

			virtual ~max_subsampling_layer_cudnn_updater_cuda();
		...
		private:
			...
			cudnnPoolingDescriptor_t subsampling_desc;
		};
	}
}
