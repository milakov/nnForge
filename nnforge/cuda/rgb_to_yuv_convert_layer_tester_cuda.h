...
namespace nnforge
{
	namespace cuda
	{
		class rgb_to_yuv_convert_layer_tester_cuda : public layer_tester_cuda
		{
		public:
			rgb_to_yuv_convert_layer_tester_cuda() = default;

			virtual ~rgb_to_yuv_convert_layer_tester_cuda() = default;
