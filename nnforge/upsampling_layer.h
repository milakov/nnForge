...
namespace nnforge
{
	class upsampling_layer : public layer
	{
	public:
		upsampling_layer(
			const std::vector<unsigned int>& upsampling_sizes,
			unsigned int feature_map_upsampling_size = 1,
			unsigned int entry_upsampling_size = 1);
	...
	public:
		std::vector<unsigned int> upsampling_sizes;
